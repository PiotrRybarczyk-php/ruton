        ...
        <div class="br-pagebody mg-t-0 pd-x-30">
            ...
            <div class="row no-gutters">
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-12 col-sm-8 col-lg-9">
                        <input class="form-control" id="email" type="text" name="alt" value="<?= @$value->email; ?>" readonly>
                    </div>
                </div>
                <div class="row no-gutters">
                    <div class="col-12 col-sm-4 col-lg-2">
                ...
                <div class="row no-gutters">
                    <div class="col-md-12 pr-0">
                        <div class="form-layout-footer bd pd-20 bd-r-0-force">
                            <button class="btn btn-secondary" onclick="location.href = '<?= base_url('panel/mails') ?>';">Powrót</button>
