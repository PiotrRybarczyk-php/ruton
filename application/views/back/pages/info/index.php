    ...
    <div class="br-mainpanel">
      <div class="pd-30">
        <h4 class="tx-gray-800 mg-b-5">Sekcja samodzielnego montażu</h4>
          ...
          <table id="datatable1" class="table display responsive nowrap">
            <thead>
              <tr>
                ...
                <th class="wd-10p align-top no-sort">Kolejność</th>
            ...
            <tbody>
              ...
              foreach ($rows as $value) : $i++; ?>
                <tr>
                  ...
                  <td class="align-middle">
                    <input id="order<?= $value->id ?>" class="form-control" onkeydown="return false" min="1" max="<?= count($rows); ?>" onchange="setOrder(<?= $value->id ?>, 'queue', '<?= $this->uri->segment(2); ?>')" style="max-width:80%;" type="number" value="<?= $value->queue; ?>">
                  </td>
                  <td class="align-middle green_i"><?php echo substr($value->title, 0, 70);
