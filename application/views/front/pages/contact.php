<div class="banner" style="background-image:url(<?= base_url('assets/front/img/texture.jpg'); ?>);">
    <div class="mask">
        <h1 class="banner_title">kontakt</h1>
...
<section>
    <div class="block_normal main_padding">
        ...
        <h1 class="contact_header">PYTANIA? - ZAPRASZAMY <i>DO KONTAKTU!</i></h1>
    </div>
