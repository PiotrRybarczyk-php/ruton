  ...
  <div class="br-sideleft-menu">
    <a href="<?php echo base_url(); ?>panel/dashboard" class="br-menu-link 
      ...
      <div class="br-menu-item">
        ...
        <span class="menu-item-label">Pulpit</span>
      </div><!-- menu-item -->
    </a><!-- br-menu-link -->
    ...
    <a href="<?php echo base_url(); ?>panel/banners" class="br-menu-link
        <?php if ($this->uri->segment(2) == 'banners' || $this->uri->segment(4) == 'banners') {
          echo 'active';
        } ?>">
      <div class="br-menu-item">
    ...
    <ul class="br-menu-sub nav flex-column">
      <li class="nav-item"><a href="<?php echo base_url(); ?>panel/s1" class="nav-link">Sekcja 1</a></li>
      <li class="nav-item"><a href="<?php echo base_url(); ?>panel/s1_tiles" class="nav-link">Sekcja 1:Kafelki</a></li>
      <li class="nav-item"><a href="<?php echo base_url(); ?>panel/s2" class="nav-link">Sekcja 2</a></li>
      <li class="nav-item"><a href="<?php echo base_url(); ?>panel/s2_tiles" class="nav-link">Sekcja 2:Kafelki</a></li>
      <li class="nav-item"><a href="<?php echo base_url(); ?>panel/s3" class="nav-link">Sekcja 3</a></li>
      <li class="nav-item"><a href="<?php echo base_url(); ?>panel/s4" class="nav-link">Sekcja z Mapą</a></li>
      <li class="nav-item"><a href="<?php echo base_url(); ?>panel/s5" class="nav-link">Sekcja Poradnika</a></li>
    </ul>
    <a href="<?php echo base_url(); ?>panel/support" class="br-menu-link
        <?php if ($this->uri->segment(2) == 'support' || $this->uri->segment(4) == 'support') {
          echo 'active';
        } ?>">
      <div class="br-menu-item">
    ...
    <a href="<?php echo base_url(); ?>panel/offer" class="br-menu-link
        <?php if ($this->uri->segment(2) == 'offer' || $this->uri->segment(4) == 'offer') {
          echo 'active';
        } ?>">
      <div class="br-menu-item">
    ...
    <a href="<?php echo base_url(); ?>panel/info" class="br-menu-link
        <?php if ($this->uri->segment(2) == 'info' || $this->uri->segment(4) == 'info') {
          echo 'active';
        } ?>">
      <div class="br-menu-item">
    ...
    <a href="<?php echo base_url(); ?>panel/blog" class="br-menu-link
        <?php if ($this->uri->segment(2) == 'blog' || $this->uri->segment(4) == 'blog') {
          echo 'active';
        } ?>">
      <div class="br-menu-item">
